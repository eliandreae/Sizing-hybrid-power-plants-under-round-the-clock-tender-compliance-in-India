...
########################################################################################################################
    ...
    def Deterministic(CO2_cost = None):
    ...
    m = Deterministic(CO2_cost=CO2_cost)
    ...
    results_yearly = pd.DataFrame.from_dict({y: {'ProdCost': m.Prod[y].value,
                                                 ...
                                                 'Util penalty': penalty_utilization_yearly_dyn[y] * m.e_nonDel_yearly[
                                                     y],
                                                 'Renew penalty': penalty_renewable_dyn[y] * m.e_renew_share[y],
