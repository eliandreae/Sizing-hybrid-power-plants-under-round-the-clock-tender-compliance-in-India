...
data11 = pd.read_csv('Results_HPC/Results_Stochastic_scen3_yearly_HPC.csv')
...
p4 = data11_3['PPA revenue']
m4 = data11_3['market revenue']
c4 = (data11_3['OpexFix'])*(-1)
o4 = (data11_3['OpexVar'])*(-1)
f4 = (data11_3['ProdCost'])*(-1)
k4 = (data11_3['Penalty'])*(-1)

x = ['Deterministic', 'Scenario 1', 'Scenario 2', 'Scenario 3']
...
# Emissions
x = ['Deterministic', 'Scenario 1', 'Scenario 2', 'Scenario 3']
y1 = np.array([sum(data22['CO2']), sum(data11_1['CO2']), sum(data11_2['CO2']), sum(data11_3['CO2'])])

# plot bars in stack manner
plt.bar(x, y1, color='lightlategrey')
...
data1_3 = data1.loc[525600:788399]

x = ['Deterministic', 'Scenario 1', 'Scenario 2', 'Scenario 3']
y1 = np.array([sum(data2['solar']), sum(data1_1['solar']), sum(data1_2['solar']), sum(data1_3['solar'])])
y2 = np.array([sum(data2['wind']), sum(data1_1['wind']), sum(data1_2['wind']), sum(data1_3['wind'])])
y3 = np.array([sum(data2['coal']), sum(data1_1['coal']), sum(data1_2['coal']), sum(data1_3['coal'])])
y4 = np.array([sum(data2['battery']), sum(data1_1['battery']), sum(data1_2['battery']), sum(data1_3['battery'])])
