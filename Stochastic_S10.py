...
file1 = results_hourly.to_csv('Results_HPC/Results_Stochastic_S10_hourly_HPC.csv', index=True, header=True)
file2 = results_yearly.to_csv('Results_HPC/Results_Stochastic_S10_yearly_HPC.csv', index=True, header=True)
file3 = optimal_capacities.to_csv('Results_HPC/Results_Stochastic_S10_capacities_HPC.csv', index=True, header=True)
file4 = results_scenario.to_csv('Results_HPC/Results_Stochastic_S10_scenario_HPC.csv', index=True, header=True)
