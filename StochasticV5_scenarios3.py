...
from parameters_Scenarios import Parameters
...
from parameters_Scenarios import Scenarios
S, Prob = Scenarios(Nscenarios)
from parameters_Scenarios import ShuffleCFs
...
file1 = results_hourly.to_csv('Results_HPC/Results_Stochastic_scen3_hourly_HPC.csv', index=True, header=True)
file2 = results_yearly.to_csv('Results_HPC/Results_Stochastic_scen3_yearly_HPC.csv', index=True, header=True)
file3 = optimal_capacities.to_csv('Results_HPC/Results_Stochastic_scen3_capacities_HPC.csv', index=True, header=True)
file4 = results_scenario.to_csv('Results_HPC/Results_Stochastic_scen3_scenario_HPC.csv', index=True, header=True)
